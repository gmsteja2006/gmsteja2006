...
- Built with FastAPI, LangGraph, MongoDB, and CrossEncoder re-ranking
- Delivers sub-second semantic search across 100+ PDFs
- Improved user engagement by 40% through refined retrieval accuracy

### [Daily Tasks Overview Website](#)
Responsive web application for organizing and tracking daily tasks.
- Built with HTML, CSS, JavaScript, and MongoDB
- Interactive UI efficiently managing 200+ stored records

### [Online Shopping Cart](#)
Console-based shopping and checkout workflow.
- Built with Java, JDBC, and SQL
- Implements cart management, checkout logic, and optimized SQL queries
...
- Solved 400+ problems across CodeChef and LeetCode
- **Certifications:**
...
- Cambridge English Empower B2 — Professional Communication
